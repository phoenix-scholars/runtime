...
import ir.co.dpq.runtime.Assert;
import ir.co.dpq.runtime.jobs.ILock;
import ir.co.dpq.runtime.jobs.ISchedulingRule;
...
public class OrderedLock implements ILock, ISchedulingRule {
	...
	/* (non-Javadoc)
	 * @see ir.co.dpq.runtime.jobs.ISchedulingRule#contains(ir.co.dpq.runtime.jobs.ISchedulingRule)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ir.co.dpq.runtime.jobs.ISchedulingRule#isConflicting(ir.co.dpq.runtime.jobs.ISchedulingRule)
	 */
	@Override
