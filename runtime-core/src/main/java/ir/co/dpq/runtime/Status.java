...
public class Status implements IStatus {
	...
	public static final IStatus ERROR_STATUS = new Status(ERROR, unknownId,
			ERROR, "error", null); //$NON-NLS-1$
	
	public static final IStatus WARNING_STATUS = new Status(WARNING, unknownId,
			WARNING, "warning", null); //$NON-NLS-1$
	
	public static final IStatus INFO_STATUS = new Status(INFO, unknownId, INFO,
			"info", null); //$NON-NLS-1$
	...
	protected void setSeverity(int severity) {
		// Assert.isLegal(severity == OK || severity == ERROR
